...
class Builder
{
    ...
    {
        $eventResult = $this->fireEvents('selecting');
        if ($eventResult !== null) {
            return $eventResult;
        }
        $executionTime = 0;
        ...
        $this->fireEvents('selected', $result, $executionTime);
        return $result;
    }
    ...
    public function update($data)
    {
        ...
        $this->fireEvents('updated', $queryObject, $executionTime);
    ...
    {
        $eventResult = $this->fireEvents('deleting');
        if ($eventResult !== null) {
            return $eventResult;
        }
        ...
        list($response, $executionTime) = $this->statement($queryObject->getSql(), $queryObject->getBindings());
        $this->fireEvents('deleted', $queryObject, $executionTime);
    ...
    {
        $eventResult = $this->fireEvents('inserting');
        if ($eventResult !== null) {
            return $eventResult;
        }
        ...
        $this->fireEvents('inserted', $return, $executionTime);
