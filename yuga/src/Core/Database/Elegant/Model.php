...
abstract class Model implements ArrayAccess, JsonSerializable
{
    ...
    protected function fillModelWithSingle($attributes)
    {
        foreach ($attributes as $key => $value) {
	...
	*/
    ...
    {
        return $this->removeHiddenFields((array) $this->attributes);
    ...
    public static function makeModels($items)
    { 
    ...
    */
    ...
    {
        static::registerModelEvent('selecting', $callback, $priority);
    }

    public static function selected($callback, $priority = 0)
    {
        static::registerModelEvent('selected', $callback, $priority);
    }
